...
func Parse(ctx context.Context, path, content string, eh llts.ErrorHandler) (*Tree, error) {
	var l llts.Lexer
	l.Init(content)
	var p llts.Parser
...
func (b *builder) addNode(t llts.NodeType, offset, endoffset int) {
	start := len(b.stack)
	end := start
...
func (b *builder) build() (*Tree, error) {
	...
	b.addNode(llts.Module, 0, len(b.tree.content))
